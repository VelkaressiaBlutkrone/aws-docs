...
- [~] **② develop → main 릴리스** — **진행 중(2026-09-03): develop이 main보다 앞섬 — weighted capacity 게이트(PR#113)·시험 게이트 해제 문서(PR#114)·SAA 오디오 24 스캐폴드+20 합성(PR#115)·SAA 오디오 20문서 청취면제 승인(PR#116, 라이브 노출·번들 493MB) → develop→main 릴리스 PR로 배포.** 직전 완료: 2026-07-03 PR#110·#112(감사 Phase A+AR). 그 이전 이력(2026-06-20 PR#47 `00528f9`): 이력: 멀티 일정 PR#31 · CLF 섹션 앵커 PR#37 `a68ae14` · **SAA 재검토 인프라(T1~T8)+T6 문서 정확성 수정+첫 flip 6 Task PR#47**(679 test·analyze 신규0·build web·배포 그린·라이브 200+로더 확인; SAA 통합시험은 D1 미flip이라 게이트 숨김 유지). develop=main 동기.
