...
| saa-t3-4 ~ t3-9 | ⬜ 대기 | 다음 스캐폴드 대상 |
| saa-t4-1 ~ t4-5 | ⬜ 대기 | |

**남은 완성 작업: 16개** (t2-2~t2-5·t3-1~t3-3 enrich/synth 재개 + t3-4~t3-9·t4-1~t4-5 스캐폴드부터).
**크레딧 충전 전 가능한 작업:** `saa-t3-4`부터 같은 방식으로 앵커·lexicon·표요약·script gate PASS까지 선행.
