...
### 4) 권한 평가 로직 (★ 단골 출제) {#policy-evaluation}
...
### 5) IAM 역할과 STS (AWS Security Token Service) {#iam-roles-sts}
...
### 7) 다계정 보안 (AWS Organizations + SCP) {#multi-account-security}
