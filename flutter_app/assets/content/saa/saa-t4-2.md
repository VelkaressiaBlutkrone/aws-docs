...
> 선납은 고객이 약정 시작 시점에 전액을 즉시 지불하므로, AWS 입장에서 미래 청구금 미수 위험이 없고 자금이 즉시 확보됩니다.
> 월납은 고객이 실제로 사용하는 기간 동안 분할 청구되어 AWS 입장에서 장기 수금 관리 비용이 발생합니다.
> 이 현금흐름 차이가 납입 방식별 할인율 차이로 반영됩니다.
...
### 7) Rightsizing — AWS Compute Optimizer
...
3. **"RI를 구매하면 언제든 취소할 수 있다."** → RI는 구매 후 **취소 불가**입니다. Standard RI는 Reserved Instance Marketplace에서 제3자에게 판매할 수 있지만, Convertible RI는 판매가 불가합니다.
   *(원리: §1 — 구체적 인스턴스 구성을 약속할수록 절감률이 높아지지만, 그 약속은 취소할 수 없는 의무이기도 하다.)*
...
5. **"No Upfront RI는 약정이 아니다."** → No Upfront RI도 1년 또는 3년 계약 의무입니다. 선납금이 없을 뿐이며, 매월 할인 요금이 청구됩니다.
   *(원리: §4 — 납입 방식은 현금흐름 차이를 결정할 뿐, 기간 약정 의무 자체는 All Upfront·No Upfront 모두 동일하다.)*
